// To parse this data:
//
//   import { Convert, DateHTTP } from "./file";
//
//   const dateHTTP = Convert.toDateHTTP(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface DateHTTP {
    data:       Gif[];
...
export class Convert {
    public static toDateHTTP(json: string): DateHTTP {
        return cast(JSON.parse(json), r("DateHTTP"));
    }

    public static dateHTTPToJson(value: DateHTTP): string {
        return JSON.stringify(uncast(value, r("DateHTTP")), null, 2);
    }
}
